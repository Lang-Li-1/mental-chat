...
# Database — PostgreSQL with fallback to SQLite for local
...
CORS_ALLOWED_ORIGINS = os.environ.get("CORS_ALLOWED_ORIGINS", "http://localhost:3000,http://localhost:5173,http://localhost:8081").split(",")
